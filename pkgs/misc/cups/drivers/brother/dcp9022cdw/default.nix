...
in
{
  driver = stdenv.mkDerivation {
    ...
    src = fetchurl {
      url = "https://download.brother.com/welcome/dlf101612/dcp9022cdwlpr-1.1.3-0.i386.deb";#https://download.brother.com/welcome/dlf100441/dcp9020cdwlpr-${version}-1.i386.deb
  ...
  cupswrapper = stdenv.mkDerivation {
    ...
    src = fetchurl {
      url = "https://download.brother.com/welcome/dlf101613/dcp9022cdwcupswrapper-1.1.4-0.i386.deb";#https://download.brother.com/welcome/dlf100443/dcp9020cdwcupswrapper-${version}-1.i386.deb
